...
function page() {
  return (
    <div>
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-8">
          <div className="w-full lg:w-full flex flex-col justify-center">
            ...
            <p className="font-normal text-base py-2 lg:text-xl leading-6 text-center px-20  text-gray-200 ">
              ...
              heard you and here is what we can deliver to ease your life.
            </p>
          </div>
      ...
      <h1 className="text-xl pt-28 lg:text-3xl font-bold leading-9 text-center capitalize text-purple-300  pb-4">
          Meet our team
        </h1>
